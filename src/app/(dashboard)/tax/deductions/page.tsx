...
export default function DeductionsPage() {
  ...
  // Servicefradrag
  const [service, setService] = useState(910); // Serwiz ~35 DKK * 26 weeks

  // Rentefradrag
  const [mortgageInterest, setMortgageInterest] = useState(100000);
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {da ? "Serwiz rengøring ~35 kr. x 26 = 910 kr./år" : "Serwiz cleaning ~35 DKK x 26 = 910 DKK/year"}
            </p>
          </div>
